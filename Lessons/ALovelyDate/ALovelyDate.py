...
print('(Press Enter to Exit the room with her!)')#prompting the print funtion to prompt user to continue
...
print()#epmty line using the prin( function)
...
print('(To be continued. . . ENTER to exit)')#letting the user know the stoyline will be continued in another program!

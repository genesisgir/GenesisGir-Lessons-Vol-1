...
print("and everyday I'm learning something new not only that I think it's imporatant to train.") # More chatter with the print function!
...
print("I'm from Baltimore and it's too loud over here and I miss my country Peru") # Telling the user that i orgin from peru
...
print() # An ampty void of text and a long line of nothing created with the print() function

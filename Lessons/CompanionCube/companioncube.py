...
"""
#This program is about escaping a facility with a cube know as companion cube!
...
standard library functions, and interactive developmeant environmeant features. 
...
print('A intercom interrupts the radio and a robotic sarcastic tone is heard')#introducing the character @glados
...
print('Im sure with some warming up you will be just fine. We are going to be great neighbors')#
...
print('GLADOS:Your going to be here for eternity') # using the print function to give realism and print values onto stream(screen)
...
print(name+':*quivers and utters the words*')#uses the print function+variable to create a sense that user is feeling emotion
print(name+':'+response)#meshes variable and another variable+print() function to make user speak
print()#empty line of code uses the print() functionality!
...
print()#empty line
response=input()#using the input function in reality to intake users reply back to glados storing it within response
...
print()#empty line of code! pretty right? 
...
In the world we live in now a lot of new or novice programmers will run to discord servers or
...
can vouch for this the art form is vast and very complex but remember the term 'Self-taught' simply
means to teach yourself the things you want to explore. Being self-taught is looked at very
indie-modern type of approach but nonetheless very beneficial. and chances are if your reading 
...
🅶🅴🅽🅴🆂🅸🆂🅶🅸🆁 🅶🅴🅽🅴🆂🅸🆂🅶🅸🆁 🅶🅴🅽🅴🆂🅸🆂🅶🅸🆁 🅶🅴🅽🅴🆂🅸🆂🅶🅸🆁 🅶🅴🅽🅴🆂🅸🆂🅶🅸🆁 
"""
print('-'+name+'looks up-')#arguments calling to print + a variable of users name
...
print('GLADOS:Good so we understand each other.')#print function being used to print glados speech to stream(screen)
...
print('-eerie silence preset and a white room with obstacles are seen-')
print('(press enter)')#prompts the user to press enter
input()#takes input from user using the input()
print('RADIO:Here at Aperture Industries we strive to keep your limbs intact *BRRr* i mean we will')
print('try our very best to do so. if in any case you do lose any limbs during the experimeant please')
...
print('GLADOS:Look at what the cat dragged in')#some insults issued by the character glados uses print functionalities
print('(press enter to read)')
input()#input to skip to next line of code!
print('-'+name+' looks at her-')#shows that the user looks over @glados uses the print call functions
print('(press enter to read)')#prompts user to press enter 
input()#takes input from users keyboard press and waits for enter key press
print('GLADOS:Im surprised to know that you can use an elevatoRrRrRrrrrr*Brr*')
...
print('(press enter to continue)')#prompts the user to press the enter key with print feature!
input()#neat another input! we use these to gather info from users!
print('-A swooshing vacuum sound is heard and a Cube falls out the vent-')#the companion cube introduces itself to setting
...
print()#empty line to give spacial depth using the 'print()' function
print('-'+name+' holds the cube now in their hands-')#letting the user know they now have the cube in their possession
...
print('-Rumble-')#the cube rumbles added for sensation of game play!
...
print('(Press enter to read)')#prompts the user to press enter using the input() in line '251'
input()#gathers the key presses from user uses the input()!
print('GLADOS:You made friends with your little toy box. That wont help you pass this course.')
print('(press enter to read)')#character boasted and insults using the print function
...
print(name+':'+'Its asking me for to put a random number.')#uses the print func+the user name variable
...
print('press enter to read')#prompts user to continue telling them to press enter!
input()#using the input function as a menu sys uses input() function
...
print('press enter to meet your savior '+CompanionCube+' the Companion Cube! Thanks for Playing!')#prompts the user if they would like to meet their cube!
